        ...
        <div class="card border-warning" style="width: 100%;">
            <div class="card-body">
                <div class="row no-gutters p-0">
                    <div class="col-8 col-xl-8 col-lg-8 col-md-7 col-sm-8">
                    <h5 class="card-title">{{$data->nama_produk}}</h5>
                    </div>
                    @if( auth('pelanggan')->check() )
                        @if($countrating == 0)
                        <div class="col-4 col-xl-4 col-lg-4 col-md-5 col-sm-4 d-flex pl-xl-4 justify-content-center" style="margin-top: -4px">
                                <a data-toggle="modal"
